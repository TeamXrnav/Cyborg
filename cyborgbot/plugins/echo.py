...
from cyborgbot.sql.echo_sql import addecho, get_all_echos, is_echo, remove_echo
from cyborgbot.sql.gvar_sql import addgvar, gvarstat, delgvar
from . import *


@cyborg_cmd(pattern="echo$")
