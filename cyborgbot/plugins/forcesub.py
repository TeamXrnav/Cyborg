...
from cyborgbot.sql.fsub_sql import *
from . import *
...
async def _(event):
    ...
    if uid == event.sender_id:
        ...
        try:
            ...
            print(str(e))
            return
        msg = f"**cyborgo {nm} !! Welcome to {(await event.get_chat()).title} ✨**"
