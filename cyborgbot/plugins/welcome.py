...
from cyborgbot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from cyborgbot.sql.gvar_sql import gvarstat, addgvar, delgvar
from . import *
...
@cyborg_cmd(pattern="savewelcome(?: |$)(.*)")
...
@cyborg_cmd(pattern="cleanwelcome$")
...
@cyborg_cmd(pattern="showwelcome$")
...
@cyborg_cmd(pattern="welcome_note$")
