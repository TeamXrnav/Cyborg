...
from cyborgbot.sql import blacklist_sql as sq
from . import *
...
@cyborg_cmd(pattern="addblacklist(?:\s|$)([\s\S]*)")
...
@cyborg_cmd(pattern="rmblacklist(?:\s|$)([\s\S]*)")
...
@cyborg_cmd(pattern="listblacklist$")
