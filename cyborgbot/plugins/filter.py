...
from cyborgbot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
from . import *
...
@cyborg_cmd(pattern="filter(?:\s|$)([\s\S]*)")
...
@cyborg_cmd(pattern="rmallfilters$")
