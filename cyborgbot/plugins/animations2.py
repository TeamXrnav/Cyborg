...
@cyborg_cmd(pattern="gnt$")
async def gn(event):
    await eor(event, "｡♥｡･ﾟ♡ﾟ･｡♥｡･｡･｡･｡♥｡･\n╱╱╱╱╱╱╱╭╮╱╱╱╭╮╱╭╮╭╮\n╭━┳━┳━┳╯┃╭━┳╋╋━┫╰┫╰╮\n┃╋┃╋┃╋┃╋┃┃┃┃┃┃╋┃┃┃╭┫\n┣╮┣━┻━┻━╯╰┻━┻╋╮┣┻┻━╯\n╰━╯╱╱╱╱╱╱╱╱╱╱╰━╯\n｡♥｡･ﾟ♡ﾟ･｡♥° ♥｡･ﾟ♡ﾟ･"
    )


@cyborg_cmd(pattern="gmg$")
async def gm(event):
    await eor(event, "｡♥｡･ﾟ♡ﾟ･｡♥｡･｡･｡･｡♥｡･｡♥｡･ﾟ♡ﾟ･\n╱╱╱╱╱╱╱╭╮╱╱╱╱╱╱╱╱╱╱╭╮\n╭━┳━┳━┳╯┃╭━━┳━┳┳┳━┳╋╋━┳┳━╮\n┃╋┃╋┃╋┃╋┃┃┃┃┃╋┃╭┫┃┃┃┃┃┃┃╋┃\n┣╮┣━┻━┻━╯╰┻┻┻━┻╯╰┻━┻┻┻━╋╮┃\n╰━╯╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━╯\n｡♥｡･ﾟ♡ﾟ･｡♥｡･｡･｡･｡♥｡･｡♥｡･ﾟ♡ﾟ･"
    )


@cyborg_cmd(pattern="bombs$")
async def _(event):
...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Me: Hello this is` `{cyborg_mention}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: Hello Sir, How are you!!`",
        "`Prime Minister: May I Know Who Is This?`",
        f"`Me: Yes sur, itz me` `{cyborg_mention}`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [Owner](https://t.me/Arnav_xD) __to release your account__😏"
            )
        else:
