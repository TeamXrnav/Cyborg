...
@cyborg_cmd(pattern="vcinvite$")
async def _(event):
    cyborg = await eor(event, "`🧐 Inviting Users To Voice Chat....`")
    users = []
    i = 0
    ...
    for k in hel_:
        try:
            ...
            pass
    await cyborg.edit(f"**🚀 Invited {i} Users to Voice Chat**")
