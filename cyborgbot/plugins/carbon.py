...
@cyborg_cmd(pattern="carbon(?:\s|$)([\s\S]*)")
async def carbon_api(e):
    cyborg = await eor(e, "`Processing..`")
    ...
    await cyborg.edit("`Processing..\n75%`")
    await asyncio.sleep(2)
    await cyborg.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await cyborg.edit("`Uploading..`")
...
async def carbon_api(e):
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)
    await cyborg.edit("`Making Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    ...
    await cyborg.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await cyborg.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await cyborg.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await cyborg.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await cyborg.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await cyborg.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await cyborg.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await cyborg.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@cyborg_cmd(pattern="rgbk2(?:\s|$)([\s\S]*)")
async def carbon_api(e):
    ...
    await cyborg.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await cyborg.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@cyborg_cmd(pattern="kargb(?:\s|$)([\s\S]*)")
async def carbon_api(e):
    RED = random.randint(0, 256)
    GREEN = random.randint(0, 256)
    BLUE = random.randint(0, 256)
    ...
    await cyborg.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await cyborg.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
