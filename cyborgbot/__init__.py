...
from cyborgbot.clients.session import H2, H3, H4, H5, Cyborg, CyborgBot 
...
if not Config.CYBORGBOT_SESSION:
    LOGS.warning("Please fill var CYBORGBOT SESSION to continue.")
    quit(1)
