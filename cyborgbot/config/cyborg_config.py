# IF YOU ARE HOSTING CYBORGBOT ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    BIO_MSG = os.environ.get("BIO_MSG", "I Am Cyborg User")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "CyborgUpdates")
    MY_GROUP = os.environ.get("YOUR_GROUP", "CyborgSupportChat")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/d09cdb53e72cd7215892e.jpg")
    REMOVE_BG_API = os.environ.get("REMOVE_BG_API", None)
    SCREEN_SHOT_LAYER_ACCESS_KEY = os.environ.get("SCREEN_SHOT_LAYER_ACCESS_KEY", None)
    STICKER_PACKNAME = os.environ.get("STICKER_PACKNAME", None)
    CYBORGBOT_SESSION = os.environ.get("CYBORGBOT_SESSION", None)
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Cyborg")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/TeamXrnav/Cyborg")
