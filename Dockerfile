...
# 
RUN wget https://raw.githubusercontent.com/TeamXrnav/Cyborg/master/cyborgrun.py
RUN wget https://raw.githubusercontent.com/TeamXrnav/Cyborg/master/requirements.txt
RUN pip3 install -r requirements.txt
CMD ["python3","cyborgrun.py"]
